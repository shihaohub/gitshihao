 ...
 * @Author: wing
 * @Description: 
 * @Date: 2022-04-19 20:09:53
 * @LastEditTime: 2022-07-29 16:27:48
 */
//
...
namespace localization{
    ...
    public:
        ...
        inline void SetIcpMaxIterations(int maxIterations){
            icp_.options.maxIterations = maxIterations;
            printf("icp_maxIterations: %d\n",icp_.options.maxIterations);
        }
        ...
        inline double GetIcpGoodness(){
            return icp_return_info_.goodness;
        }

        inline double GetIcpQuality(){
            return icp_return_info_.quality;
        }
