/*
 * @Author: your name
 * @Date: 2021-05-19 09:27:50
 * @LastEditTime: 2021-05-26 22:22:40
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /localization_v2_ws/src/lidar_localiztion/localization/localization/src/ekf/ekf_pose.h
 */
/**
  *ekf_pose.h
...
public:
    ...
    void getErrParam(double speed_err_,double imu_err_){
        speed_err = speed_err_;
        imu_err = imu_err_;
    }
     ...
     * @param time current time in second.
     */
    geometry_msgs::Pose2D slamStateUpdate(Eigen::Vector3d &Z_slam, const Eigen::Matrix3d &R_slam, const double time);
